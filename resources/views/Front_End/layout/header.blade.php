                ...
                <div class="ml-auto d-flex align-items-center">
                    <ul class="list-inline mb-0 mr-2 pr-1">
                        <li class="list-inline-item">
                            <a class="btn btn-sm btn-icon btn-pill btn-soft-white btn-bg-transparent transition-3d-hover"
            ...
            <nav class="js-mega-menu navbar navbar-expand-xl u-header__navbar u-header__navbar--no-space">
                ...
                <a class="navbar-brand u-header__navbar-brand u-header__navbar-brand-center u-header__navbar-brand-collapsed"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="55px"
                        height="53px" style="margin-bottom: 0;">
                ...
                <div id="navBar"
                    ...
                    <ul class="navbar-nav u-header__navbar-nav">
                        ...
                        <!-- End Home -->
                        <li class="nav-item  u-header__nav-item">
                            <a class="nav-link" style="font-weight:bold" href="{{ route('view_hotel') }}">Hotels</a>
                        </li>
                        <li class="nav-item  u-header__nav-item">
                            <a class="nav-link" style="font-weight:bold" href="{{ route('view_tour') }}">Tours</a>
                        </li>
                        <li class="nav-item  u-header__nav-item">
                            <a class="nav-link" style="font-weight:bold" href="{{ route('view_flight') }}">Flights</a>
                        </li>
                        <li class="nav-item  u-header__nav-item">
