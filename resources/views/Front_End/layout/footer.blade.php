            ...
            <div class="row justify-content-xl-between">
                        ...
                        <div class="mb-5 mr-md-7 mr-lg-0">
                            ...
                            <a href="tel:(888)-1234-56789">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="mb-2 h6 font-weight-normal text-gray-1">Got Questions ? Call
                                            us 24/7!</div>
                                        <small class="d-block font-size-18 font-weight-normal text-primary">Call
                                            Us: <span class="text-primary font-weight-semi-bold">(888) 1234
                                                56789</span></small>
                                    </div>
                                </div>
                            </a>
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xl-1dot8 mb-6 mb-md-10 mb-xl-0">
                    ...
                    <ul class="list-group list-group-flush list-group-borderless mb-0">
                        ...
                        <li><a class="list-group-item list-group-item-action text-decoration-on-hover"
                                href="#">Privacy Statement</a></li>
                        <li><a class="list-group-item list-group-item-action text-decoration-on-hover"
                                href="#">Give Us Feedbacks</a></li>
                    </ul>
                    <!-- End List Group -->
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xl-1dot8 mb-6 mb-md-10 mb-xl-0">
                    ...
                    <ul class="list-group list-group-flush list-group-borderless mb-0">
                        ...
                        <li><a class="list-group-item list-group-item-action text-decoration-on-hover"
                                href="#">Rewards Program</a></li>
                        <li><a class="list-group-item list-group-item-action text-decoration-on-hover"
                                href="#">PointsPLUS</a></li>
                        <li><a class="list-group-item list-group-item-action text-decoration-on-hover"
                                href="#">Partners</a></li>
                        <li><a class="list-group-item list-group-item-action text-decoration-on-hover"
                                href="#">List My Hotel</a></li>
                    </ul>
                    <!-- End List Group -->
                </div>
                    ...
                    <form class="js-validate js-focus-state js-form-message" novalidate="novalidate">
                        ...
                        <div class="input-group">
                            <input type="email"
                                ...
                                aria-label="Your email address" aria-describedby="subscribeButtonExample3" required=""
                                data-msg="Please enter a valid email address." data-error-class="u-has-error"
                                data-success-class="u-has-success">
                            <div class="input-group-append ml-3">
                                <button class="btn btn-sea-green border-radius-3 height-54 min-width-112 font-size-14"
                                    type="submit" id="subscribeButtonExample3">Subscribes</button>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="container">
            <div class="row d-block d-xl-flex align-items-md-center">
                <div class="col-xl-4 mb-4 mb-xl-0">
                    <!-- Logo -->
                    <a class="d-inline-flex align-items-center" href="{{ route('homepage') }}" aria-label="MyTravel">
                        <img src="../../front_assest/assets/logo_color.png" style="width: 200px;" alt="" srcset="">
                    </a>
                    <!-- End Logo -->
                </div>
                <div
                    ...
                    <div class="mb-4 mb-lg-0">
                        <ul class="d-flex list-unstyled mb-0">
                            <li class="mr-2 ml-0"><img class="max-width-40" src="../../front_assest/assets/img/icons/img3.png"
                                    alt="Payment Icons"></li>
                            <li class="mx-2"><img class="max-width-40" src="../../front_assest/assets/img/icons/img4.png"
                                    alt="Payment Icons"></li>
                            <li class="mx-2"><img class="max-width-40" src="../../front_assest/assets/img/icons/img5.png"
                                    alt="Payment Icons"></li>
                            <li class="mx-2"><img class="max-width-40" src="../../front_assest/assets/img/icons/img6.png"
                                    alt="Payment Icons"></li>
                            <li class="ml-2 mr--0"><img class="max-width-40" src="../../front_assest/assets/img/icons/img7.png"
                                    alt="Payment Icons"></li>
                        </ul>
                    </div>
    ...
    <div class="space-1">
        <div class="container">
            <div class="d-lg-flex d-md-block justify-content-between align-items-center">
                <!-- Copyright -->
                <p class="text-muted mb-3 mb-lg-0 text-gray-1">© 2024 syriatra. All rights reserved</p>
                <!-- End Copyright -->

                <!-- Social Networks -->
                <ul class="list-inline mb-0">
                    <li class="list-inline-item  pb-3 pb-md-0">
                        <a class="list-group-item-action text-decoration-on-hover pr-3"
                            href="{{ route('homepage') }}">Home</a>
                    </li>
                    <li class="list-inline-item  pb-3 pb-md-0">
                        <a class="list-group-item-action text-decoration-on-hover pr-3"
                            href="{{ route('view_hotel') }}">Hotel</a>
                    </li>
                    <li class="list-inline-item  pb-3 pb-md-0">
                        <a class="list-group-item-action text-decoration-on-hover pr-3"
                            href="{{ route('view_tour') }}">Tour</a>
                    </li>
                    <li class="list-inline-item  pb-3 pb-md-0">
                        <a class="list-group-item-action text-decoration-on-hover pr-3"
