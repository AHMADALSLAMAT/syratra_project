...
<div class="grid" id="travelType">
    <label class="flight_card">
        <input name="plan" class="radio" type="radio" checked value="free">
        <span class="plan-details">
            <span class="plan-type">
                STANDER TICKET</span>
            <span class="plan-cost free">$0</span>
            <span> <i class="fa fa-xmark"></i> No need for flexibility - you're sure of your plans</span>
            <hr style="width: 100%;height:1px;background:#ccc">

        </span>
    </label>
    <label class="flight_card">
        <input name="plan" class="radio" type="radio" value="paid">
        <span class="plan-details" aria-hidden="true">
            <span class="plan-type">FLEXABILE TICKET</span>
            <span class="plan-cost paid">$50</span>
            <span>Switch flights up to 24 hours before your departure time – with no penalties</span>
            <hr style="width: 100%;height:1px;background:#ccc">
