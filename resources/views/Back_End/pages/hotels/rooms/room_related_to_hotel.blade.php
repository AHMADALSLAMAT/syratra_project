...
<main class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">ADD ROOMS</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">ADD NEW ROOM FOR {{ $hotel->hotel_name }}</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <form action="{{ route('hotels_rooms.add_post') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="card-header py-3 bg-transparent">
                        <div class="d-sm-flex align-items-center">
                            <h5 class="mb-2 mb-sm-0">Room For <small>{{ $hotel->hotel_name }}</small> </h5>
                            <div class="ms-auto">
