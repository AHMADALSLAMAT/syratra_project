...
class InternalFlightseeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $airports = Airport::where('countryName','SYRIA')->get();
        ...
        for ($i = 0; $i < 100; $i++) {
            ...
            $data = [
                ...
                'flight_arrive_date' => $leaveDate->copy()->addHours(rand(1, 5))->toDateString(),
