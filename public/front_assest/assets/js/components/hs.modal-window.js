...
(function ($) {
    ...
    $.HSCore.components.HSModalWindow = {
        ...
        initHashLinkPopup: function (popup, config) {
            ...
            if (hashItem.length && hashItem.attr("id") == popup.attr("id")) {
                new Custombox.modal({
                    ...
                    overlay: {
                        color:
                            popup.data("overlay-color") ||
                            config["overlayColor"],
                        opacity:
                            popup.data("overlay-opacity") ||
                            config["overlayOpacity"],
        ...
        initOnScrollPopup: function (popup, config) {
            var self = this,
                $window = $(window),
                breakpoint = popup.data("breakpoint")
                    ? popup.data("breakpoint")
                    : 0,
                target = $("#" + popup.attr("id"));
                    ...
                    if (e.clientY < 10 && !count) {
                        ...
                        new Custombox.modal({
                            content: {
                                target: "#" + popup.attr("id"),
                                effect:
                                    popup.data("effect") || config["effect"],
                                onOpen: function () {
                                    config["onOpen"].call($(target));
                                },
                                onClose: function () {
